...
## Project Structure
    ...
    ├── tst_heroku_deploy_37672  # Django project configurations
...
1. Clone this repo and `cd tst_heroku_deploy_37672`
...
2. Clone this repo and `cd tst_heroku_deploy_37672`
